            ...
            <article>
                ...
                <div class="row">
                    <div class="leftcolumn">
                        ...
                        <div class="card">
                            <h2>Feedback </h2>
                            <h5>Mijn verwerking van de feedback, Sep 10, 2021</h5>
                            <img src="../images/feedb.jpg" alt="Feedback" style="height:200px;"> <br>
                            <a href="blog/feedback" target="_self">Klik hier voor het volledige artikel.</a>
                        </div>

                        <div class="card">
                            <h2>Programmeerervaring </h2>
                            <h5>Hoeveel ervaring heb ik met programmeren?, Sep 9, 2021</h5>
                            <img src="../images/programmeren.jpg" alt="Programmeerervarig" style="height:200px;"> <br>
                            <a href="blog/ervaring" target="_self">Klik hier voor het volledige artikel.</a>
                        </div>
                        <div class="card">
                            <h2>Persoonlijke SWOT analyse </h2>
                            <h5>Persoonlijke sterktes en zwaktes analyseren en kansen en bedreigingen inventariseren, Sep 8, 2021
                            </h5>
                            <img src="../images/swot.png" alt="SWOT Analyse" style="height:200px;"> <br>
                            <a href="blog/swot" target="_self">Klik hier voor het volledige artikel.</a>
                        </div>
                        <div class="card">
                            <h2>Studiekeuze</h2>
                            <h5>Motivatie en ervaring in het gebied van ICT, Sep 7, 2021</h5>
                            <img src="../images/studiekeuze.jpg" alt="Studiekeuze" style="height:200px;"> <br>
                            <a href="blog/studiekeuze" target="_self">Klik hier voor het volledige artikel.</a>
                        </div>
                    </div>
                </div>
            </article>
